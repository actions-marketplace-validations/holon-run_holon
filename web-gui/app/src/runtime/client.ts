...
function projectWorkItem(workItem: WorkItemTransportDto | undefined, currentWorkItemId?: string | null): WorkItemSummary | undefined {
  ...
  return {
    ...
    readiness: "readiness" in workItem ? workItem.readiness : undefined,
    schedulingState: "scheduling_state" in workItem ? workItem.scheduling_state : undefined,
    focus: "focus" in workItem ? workItem.focus : undefined,
